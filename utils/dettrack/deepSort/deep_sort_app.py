...
def create_detections(detection_mat, frame_idx, min_height=0):
    ...
    """
    frame_indices = detection_mat[:, 0].astype(np.int) # 从 .npy 文件中选择当前帧的目标检测结果
...
def run(sequence_dir, detection_file, output_file, min_confidence,
    ...
    def frame_callback(vis, frame_idx):
        ...
        if display:
            image = cv2.imread(
                seq_info["image_filenames"][frame_idx], cv2.IMREAD_COLOR) # 注意：图片的名称要和 .npy 数据的第一列一致
...
def parse_args():
    ...
    parser.add_argument(
        ...
        # required=True, 
        type=str,
        default="/home/linsi/VisDrone-Object-Tracking/Dataset/MOT16/test/MOT16-06", 
        # default="/home/linsi/VisDrone-Experiences/Appreance-Feature/outputs/deepsort-format/d11-images",
        help="Path to MOTChallenge sequence directory")
    parser.add_argument(
        "--detection_file", 
        # required=True,
        type=str,
        default="/home/linsi/VisDrone-Object-Tracking/Dataset/Deep_SORT_pre-detection/detections/MOT16_POI_test/MOT16-06.npy",
        # default="/home/linsi/VisDrone-Experiences/Appreance-Feature/outputs/deepsort-format/d11-images/d11-images.npy",
        help="Path to custom detections.")
    parser.add_argument(
        "--output_file", 
        type=str,
        default="./outputs/hypotheses.txt",
